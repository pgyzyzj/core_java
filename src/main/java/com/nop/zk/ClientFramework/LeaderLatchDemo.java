...
/**
 * Created by yangzijun on 17-3-30.
 */
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            for (int i = 0; i < CLIENT_QTY; ++i) {
                ...
                List<String> servers=Lists.newArrayList("127.0.0.1:2181");

                //server.getConnectString()
                CuratorFramework client = CuratorFrameworkFactory.newClient(Joiner.on(",").join(servers).toString(), new ExponentialBackoffRetry(1000, 3));
                clients.add(client);
